...
Original file is located at
    https://colab.research.google.com/drive/1jF8PEQr6J1mXZtbp7yxidwmj5GuljAs2
...
This method consists in many repetitions of decision tree regression. The trees are chose randomly and we consider the total average to fit the model.
...
This example is a simple demonstration how to apply the random forest regression. This method is very similar to Decision Tree Regression. But here we have a certain number of decision tree chose randomly and from these repetitions we take the mean. The results is satisfactory and we have more information about intermediate values, these values do not appear in a single decision tree model.
"""