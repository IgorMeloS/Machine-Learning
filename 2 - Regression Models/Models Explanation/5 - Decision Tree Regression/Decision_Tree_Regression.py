...
Original file is located at
    https://colab.research.google.com/drive/1MG0AN-2L7YtkqkHw_ps_G_t7LarDl3zD
...
This program is a simple example to demonstrate how to apply the decision tree regression. Note that this model is not convenient if we have few  independent variables. In the results we can see a good prediction just in the original points, but for intermediate values, prediction is not satisfactory.
"""