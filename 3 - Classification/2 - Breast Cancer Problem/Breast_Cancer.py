...
Original file is located at
    https://colab.research.google.com/drive/1xnqjcuLQu7tPqTLIij3juhUKKexhAcW-
...
sns.pairplot(cancer_df, hue = 'target', vars = ['mean radius', 'mean area', 'mean perimeter', 'worst radius', 'worst perimeter', 'worst area'] )
